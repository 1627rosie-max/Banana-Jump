...
public class PlayerScript : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        {
            playerBody.linearVelocity = new Vector2(moveSpeed, playerBody.linearVelocity.y);
    ...
    void OnTriggerEnter2D(Collider2D target)
    {
        ...
        if (target.tag == "ExtraPush")
        {
            if (!initialPush)
            {
                ...
                playerBody.linearVelocity = new Vector2(playerBody.linearVelocity.x, 18f);
        ...
        {
            playerBody.linearVelocity = new Vector2(playerBody.linearVelocity.x, normalPush);
        ...
        if(target.tag == "ExtraPush")
        {
            playerBody.linearVelocity = new Vector2(playerBody.linearVelocity.x, extraPush);
